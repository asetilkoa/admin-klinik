...
// input data ke database
    public function addDtPasien()
    {
        ...
        $aes = new Aes();
        DataPasien::create([
            'Nomor_Reg' => $aes->enkripAes($this->Nomor_Reg),
            'Nama_Lengkap' => $aes->enkripAes($this->Nama_Lengkap),
            'Jenis_Identitas' => $aes->enkripAes($this->Jenis_Identitas),
            ...
            'Jaminan_Kesehatan' => $aes->enkripAes($this->Jaminan_Kesehatan),
...
// menempilkan data pada database
    public function editPasien(int $pasien_id)
    {
        ...
        $this->Nomor_Reg = $aes->dekripAes($pasien->Nomor_Reg);
        $this->Nama_Lengkap = $aes->dekripAes($pasien->Nama_Lengkap);
        $this->Jenis_Identitas = $aes->dekripAes($pasien->Jenis_Identitas);
        ...
        $this->Jaminan_Kesehatan = $aes->dekripAes($pasien->Jaminan_Kesehatan);
